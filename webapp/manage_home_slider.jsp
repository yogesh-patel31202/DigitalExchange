				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="#">Home Slider Report</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
								...
								ArrayList<HomeSliderDto> list = service.getHomeSliderInfo(config, request);

								for (HomeSliderDto dto : list) {
								%>
								
								<tr>

									<td id="name-td"><%=list.indexOf(dto) + 1%></td>
									<td class="main-color d-flex justify-content-center"> 
									<div class="align-item-center">
											<img src="HomeSliderImage/<%=dto.getId()%>.jpg" 
												style="height: 110px; width: 150px;" alt="No Photo" />
										</div>
									</td>
									...
									<td><a class="main-color"
										href="edit_home_slider.jsp?id=<%=dto.getId()%>"><i
