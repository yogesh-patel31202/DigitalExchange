			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="images/newSell/volet2.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Man's Wollate</a></p>
							...
							<tr>
								<td class="image" data-title="No"><img src="images/newSell/volet.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Woman Sell</a></p>
									<p class="product-des">..</p>
								</td>
								<td class="price" data-title="Price"><span>&#8377;110.00 </span></td>
								<td class="qty" data-title="Qty"><!-- Input Order -->
							...
							<tr>
								<td class="image" data-title="No"><img src="images/newSell/volet3.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									...
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="images/sell/bag2.png" alt="#">
											</div>
											<div class="single-slider">
