				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="#">Manage Product Report</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-12 col-12">
							<div class="form-main">
								...
								<tr>
									...
									<%if(dto.getAdmin_name()==null){out.print("<td></td>");}else{%><td><%=dto.getAdmin_name()%></td><% } %>
									<%if(dto.getAdmin_mobile()==null){out.print("<td></td>");}else{%><td><%=dto.getAdmin_mobile()%></td><% } %>
